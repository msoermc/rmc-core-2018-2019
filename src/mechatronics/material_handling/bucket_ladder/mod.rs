...
use crate::mechatronics::material_handling::bucket_ladder::state::GlobalActuatorState;
use std::sync::Arc;
...
impl Digger {
    pub fn new(digger: MotorGroup, actuators: MotorGroup, life: GlobalLifeStatus) -> Self {
        Self {
            ...
            actuators,
            digger,
            digger_state: DiggerAction::STOPPED,
            actuator_state: ActuatorAction::STOPPED,
            life,
        }
    }
